...
//                         <path d={postIndex === 1 ? "M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" : "M5 12h14a1 1 0 0 1 0 2H5a1 1 0 0 1 0-2zm7-7a1 1 0 0 1 1 1v14a1 1 0 0 1-2 0V6a1 1 0 0 1 1-1z"} />
//                       </svg>
//                     </span>
...
//             <div className="relative px-4 sm:px-6 py-6 sm:py-8 md:py-10 z-10">
...
//                 <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2 sm:mb-4 text-center">Bạn cần hỗ trợ?</h2>
//                 <p className="mb-4 sm:mb-6 md:mb-8 max-w-xl mx-auto text-center text-white/90 font-light text-sm sm:text-base">
...
//                   <a
//                     href="#"
//                     className="flex items-center justify-center px-4 sm:px-6 py-2 sm:py-3 bg-white text-blue-600 font-medium rounded-full hover:bg-blue-50 transition-all duration-200 shadow-md hover:shadow-lg group text-sm"
//                   >
...
//                       <svg className="w-3 h-3 sm:w-4 sm:h-4" viewBox="0 0 24 24" fill="#1877F2">
        ...
        <div className="flex gap-4 flex-col lg:flex-row">
          ...
          <div className="grid xs:grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4 flex-1">
            ...
            <div className="inline-flex border-white w-full shadow-2xl rounded-xl px-2 sm:px-4 py-2 border-2 gap-2 sm:gap-4">
              <div className="self-center">
                <span className="text-xl sm:text-2xl font-bold">
                  <SafeCounter end={13000} duration={2.5} separator="," />+
                </span>
                <p className="font-medium text-sm sm:text-lg">Khách hàng</p>
              </div>
              <div className="bg-zinc-500 inline-block w-0.5 rounded"></div>
            ...
            <div className="inline-flex border-white w-full shadow-2xl rounded-xl px-2 sm:px-4 py-2 border-2 gap-2 sm:gap-4">
              <div className="self-center">
                <span className="text-xl sm:text-2xl font-bold">
                  <SafeCounter end={8500} duration={2.5} separator="," />+
                </span>
                <p className="font-medium text-sm sm:text-lg">Khách hàng</p>
              </div>
              <div className="bg-zinc-500 inline-block w-0.5 rounded"></div>
            ...
            <div className="inline-flex border-white w-full shadow-2xl rounded-xl px-2 sm:px-4 py-2 border-2 gap-2 sm:gap-4">
              <div className="self-center">
                <span className="text-xl sm:text-2xl font-bold">
                  <SafeCounter end={97} duration={2.5} separator="," />%
                </span>
                <p className="font-medium text-sm sm:text-lg">Khách hàng</p>
              </div>
              <div className="bg-zinc-500 inline-block w-0.5 rounded"></div>
